...
public class Interview1 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		By noOfElement = By.xpath("//select[@name = 'NoOfEmployees']/option");
		selectDropDownValueWithoutSelectClass(noOfElement, "0 - 10");
		
		By country = By.xpath("//select[@name = 'Country']/option");
		selectDropDownValueWithoutSelectClass(country, "Afghanistan");
